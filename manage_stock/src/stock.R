...
# _______________________________________________________
# Tue Jan 28 20:30:04 2020 ------------------------------
insertTradeData(name="삼성전자", price=59100, quantity=13, tradeType="매수",
                tradeStrategy="장기투자", market="코스피",
                account="삼성", date="2020-01-28")
saveData()
# updateBalancedData 함수 지금 이상함
# 삼성전자 거래한것도 balancedData에 반영 안되어 있음음
# _______________________________________________________
